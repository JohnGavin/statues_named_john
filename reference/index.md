...
- [`clean_names()`](https://johngavin.github.io/statues_named_john/reference/clean_names.md)
...
- [`compare_johns_vs_women()`](https://johngavin.github.io/statues_named_john/reference/compare_johns_vs_women.md)
...
- [`get_statues_wikidata()`](https://johngavin.github.io/statues_named_john/reference/get_statues_wikidata.md)
  : Retrieve Statue Data from Wikidata
- [`get_subject()`](https://johngavin.github.io/statues_named_john/reference/get_subject.md)
  : Get detailed information about a specific subject
- [`get_subjects_by_category()`](https://johngavin.github.io/statues_named_john/reference/get_subjects_by_category.md)
  : Get subjects by category
- [`get_subjects_by_gender()`](https://johngavin.github.io/statues_named_john/reference/get_subjects_by_gender.md)
