...
The following code defines the `targets` pipeline used to generate the analysis objects.
...
plan_path <- file.path(root_dir, "R/tar_plans/memorial_analysis_plan.R")

if (file.exists(plan_path)) {
  plan_code <- readLines(plan_path)
  cat(paste(plan_code, collapse = "\n"))
} else {
  cat("# Plan file not found")
}
cat("\n```")
```
